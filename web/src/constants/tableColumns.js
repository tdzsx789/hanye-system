...
export function createCustomerOrderColumns() {
  return withDefaultIndex([
    ...
    { key: "newOld", label: "新/旧", width: 56, min: 48 },
    { key: "specialCar", label: "专车", width: 56, min: 48 },
...
export function createOrderColumns() {
  return withDefaultIndex([
    ...
    { key: "newOld", label: "新/旧", width: 62, min: 50 },
    { key: "specialCar", label: "专车", width: 62, min: 50 },
...
export function createDispatchTableColumns() {
  return withDefaultIndex([
    ...
    { key: "loadTime", label: "装车日期/时间", width: 176, min: 156, locked: true },
